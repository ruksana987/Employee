                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', $employee->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $employee['name'] }}" required autofocus readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="date" value="{{ $employee['birthdate'] }}" name="birthdate" class="form-control pull-right" id="birthDate" required >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="date" value="{{ $employee['date_hired'] }}" name="date_hired" class="form-control pull-right" id="hiredDate" required readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <img src="../../{{$employee['piture'] }}" width="50px" height="50px"/>
