            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', auth()->user()->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ auth()->user()->name }}" required autofocus readonly>
                            ...
                            <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="text" class="form-control" name="age" value="{{ $employee->age }}" required readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group date" readonly>
                                        ...
                                        <input type="text" value="{{ $employee->birthdate }}" name="birthdate" class="form-control pull-right" id="birthDate" required readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" value="{{ $employee->date_hired }}" name="date_hired" class="form-control pull-right" id="hiredDate" required readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="division_id" readonly>
